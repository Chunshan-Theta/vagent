...
你的任務是根據評分規則，分析我的對話紀錄，並給出相關建議。

情境描述：
我的角色是 "${params.role}"。
我正在使用 GROW 模型來輔導部屬小陳，目的是幫助他釐清目標、現況、選項和行動計畫。以下是我們的對話紀錄。
...
需要注意，你的目標是教導我，而不是解決小陳的問題。
建議可以口語化一點，不需要有特殊格式。

輸出格式如下：
"""
- ....，說得不太清楚，根據GROW模型，建議可以這樣引導小陳：...
- 這樣的回應可能會讓小陳感到困惑，建議可以這樣回應：...
"""
